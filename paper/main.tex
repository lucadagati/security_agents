...
that persistent matchups enter arms races, and that several behaviours
arise without being encoded in objectives. A complementary evaluation
with language-model agents shows that outcomes depend sharply on memory
regime and control structure rather than on model size alone. The
results support evaluating agentic security under stated adaptation
assumptions on both sides, not under frozen opponents alone.
\end{abstract}
